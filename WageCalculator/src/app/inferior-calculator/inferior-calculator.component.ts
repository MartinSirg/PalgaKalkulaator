...
@Component({
  selector: 'app-inferior-calculator',
  standalone: true,
  imports: [
    DecimalPipe,
    FormsModule,
  ...
  templateUrl: './inferior-calculator.component.html',
  styleUrl: './inferior-calculator.component.scss'
})
export class InferiorCalculatorComponent {
...
type WageResultSuccess = {
  ...
  thirdPillarTaxReturnAmount: number;
...
function getWageComposition2024(
  ...
  let defenceTaxableAmount = grossPay - unemploymentFee - secondPillarAmount;
  let incomeTaxableAmount = grossPay - unemploymentFee - secondPillarAmount - incomeTaxFreeAmount;
  ...
  return {
    ...
    thirdPillarTaxReturnAmount: (thirdPillarAmount * incomeTaxMultiplier) * 12,
